...
import 'package:week_3_blabla_project/data/repository/rides_repository.dart';
...
class RidesService {
  ...
  List<Ride> getAvailableRides(RidePreference pref, RideFilter? filter) {
  return getRidesFor(pref, filter);
}
}
